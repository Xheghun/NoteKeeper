...
public class DatabaseDataWorker {
    ...
    private void insertNote(String courseId, String title, String text/*, String date*/) {
        ContentValues values = new ContentValues();
        ...
        //values.put(NoteKeeperDatabaseContract.NoteInfoEntry.COLUMN_NOTE_CREATION_DATE, date);
