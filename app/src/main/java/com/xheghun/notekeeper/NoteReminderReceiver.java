...
public class NoteReminderReceiver extends BroadcastReceiver {
    public static final String EXTRA_NOTE_TITLE = "com.xheghun.notekeeper.extra.NOTE_TITLE";
    public static final String EXTRA_NOTE_TEXT = "com.xheghun.notekeeper.extra.NOTE_TEXT";
    public static final String EXTRA_NOTE_ID = "com.xheghun.notekeeper.extra.NOTE_ID";
