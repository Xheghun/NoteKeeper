        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.text_note_title),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("what's up motherfuckerrrr"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.text_note_text),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("yorlang is trash!!!!"), closeSoftKeyboard());

        ViewInteraction editText = onView(
                allOf(withId(R.id.text_note_title), withText("what's up motherfuckerrrr"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        editText.check(matches(withText("what's up motherfuckerrrr")));
